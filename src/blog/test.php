...
<html lang="en">
  ...
  <body>
      ...
      <section class="hero-seation">
        ...
        <div class="error-node">
          <div class="variable-node">
            <h1 class="where-will-you">Amsterdam(Country)</h1>
            <div class="group-node">
              <div class="lorem-ipsum-dolor">
                This is the main page for travel blogs. over here will supplement the differnet info of each country and allow the user to be able to generate their response
              </div>
            </div>
            <div class="call-node">
              <h1 class="lets-go">Let’s Go....(Add to cart button here instead? ).</h1>
            </div>
          </div>
        </div>
        <div class="index-node">
          <img class="index-node-child" alt="" />
    ...
    <!-- Page Content -->
    <!-- <div class="page-heading about-heading header-text" style="background-image: url(/asset/image/Amsterdam.jpg);">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="text-content">
            <h1>Amsterdam, Netherlands</h1>
              <h4>Yeow Dao Xing  &nbsp;&nbsp;&nbsp;&nbsp;   14 March 2024   &nbsp;&nbsp;&nbsp;&nbsp;  114</h4>
    ...
    <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="text-content">
                <h1>Amsterdam: A City that Captivates Your Heart</h1>
              <h4>Yeow Dao Xing  &nbsp;&nbsp;&nbsp;&nbsp;   14 March 2024   &nbsp;&nbsp;&nbsp;&nbsp;  114</h4>
    ...
    <div class="products">
      <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                <img class="landscape-photo" alt="" src="/asset/image/Bridge.jpg" />
</div>
            <div class="col-md-8">
