...
<head>
  ...
  <link rel="stylesheet" href="/asset/css/blog/post.blog.css" />
...
<body>
  ...
  <section class="blog-container">
    <div class = "row">
        ...
        <!-- para 1 (One Image, one para)-->
        <div class = "para-1-row">
            <div class="photo-row">
                    <img src="/asset/image/LogoutVietnam1.JPG" class="landscape-photo" alt="">
            </div>
            <div class="full-box">
            ...
            <!-- para 2 row(one image, one para, 4 image, one para) -->
            <div class = "para-2-row">
                <div class = "full-box">
                    <div class = "section-heading">
                        <h1>Nightlife</h1>
                    </div>
                </div>
                <div class="sixty-six-box">
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quaerat, sed. Ex, id autem cum assumenda, quisquam cupiditate amet dolorem atque ipsam pariatur sequi voluptatem est nesciunt eum, aspernatur, tenetur rem. <br>
                ...
                <div class = "thirty-three-box">
                    <img src="/asset/image/LoginJapan.JPG" class="vert-small-photo" alt="">
                </div>
                <div class="photo-row">
                    <div class="twenty-five-box">
                        <img src="/asset/image/LogoutJapan2.JPG" class="vert-small-photo" alt="">
                    </div>
                    <div class="twenty-five-box">
                        <img src="/asset/image/LogoutJapan2.JPG" class="vert-small-photo" alt="">
                    </div>
            ...
            <!-- para 3 row (one image, one para, 1para, 1 image, 1 para) -->
            <div class = "para-3-row">
                <div class = "full-box">
                    <div class = "section-heading">
                        <h1>WOW amazing content</h1>
                    </div>
                </div>
                <div class = "fifty-box">
                    <img src="/asset/image/LoginJapan.JPG" class="vert-small-photo" alt="">
